...
const validationEditUserSchema = yup.object().shape({
  ...
  [EditUserPayloadKey.SURNAME]: yup.string().required(RegisterValidationMessage.EMAIL_REQUIRED),
  ...
  [EditUserPayloadKey.PHONE]: yup.string().required(RegisterValidationMessage.PHONE_REQUIRED).phone(RegisterValidationMessage.PHONE_INCORRECT),
