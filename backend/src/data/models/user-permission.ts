...
const createUserPermissionModel = (orm: Sequelize): ModelCtor<UserPermissionInstance> => {
  const UserPermission = orm.define<UserPermissionInstance>(ModelName.USER_PERMISSION, {
