...
module.exports = {
  up: async (queryInterface, Sequelize) =>
    queryInterface.sequelize.transaction(transaction => Promise.all([
      queryInterface.addColumn('diagnoses', 'userId', {
        type: Sequelize.UUID,
        references: {
          model: 'users',
          key: 'id'
      ...
      queryInterface.addColumn('appointments', 'userId', {
        type: Sequelize.UUID,
        references: {
          model: 'users',
          key: 'id'
      ...
      queryInterface.addColumn('doctors', 'userId', {
        type: Sequelize.UUID,
        references: {
          model: 'users',
          key: 'id'
      ...
      queryInterface.addColumn('doctors', 'clinicId', {
        type: Sequelize.UUID,
        references: {
          model: 'clinics',
          key: 'id'
      ...
      queryInterface.addColumn('doctors', 'documentId', {
        type: Sequelize.UUID,
        references: {
          model: 'documents',
          key: 'id'
  ...
  down: async queryInterface => queryInterface.sequelize
    .transaction(transaction => Promise.all([
      ...
      queryInterface.removeColumn('appointments', 'doctorId', { transaction }),
